...
def home():
    ...
    html = html.replace('{content}', main_renderer.get_html_file(cnv_path('assets/html/home.html')))
    html = html.replace('{home_content}', main_renderer.get_html_file(cnv_path('data/home_content.html')))
